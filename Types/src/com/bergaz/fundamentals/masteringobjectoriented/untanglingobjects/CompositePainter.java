...
public class CompositePainter implements Painter{
    ...
    public Duration estimateTimeToPaint(double sqMeters, Velocity totalVelocity) {
    ...
    private Velocity estimateTotalVelocity(double sqMeters) {
        return Painter.stream(this.painters).available()
    ...
    public Velocity estimateVelocity(double sqMeters) {
        return this.estimateTotalVelocity(sqMeters);
    }
